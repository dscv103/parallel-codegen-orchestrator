...
class TestFormatResultsComment:
    ...
    def test_format_results_comment_all_successful(
        ...
        comment = automation_handler._format_results_comment(sample_task_results)  # noqa: SLF001
    ...
    def test_format_results_comment_with_failures(
        ...
        comment = automation_handler._format_results_comment(failed_task_results)  # noqa: SLF001
    ...
    def test_format_results_comment_all_failed(self, automation_handler):
        ...
        comment = automation_handler._format_results_comment(all_failed)  # noqa: SLF001
    ...
    def test_format_results_comment_truncates_long_errors(
        ...
        comment = automation_handler._format_results_comment(results)  # noqa: SLF001
...
class TestDetermineStatusLabel:
    ...
    def test_determine_status_label_all_successful(
        ...
        label = automation_handler._determine_status_label(sample_task_results)  # noqa: SLF001
    ...
    def test_determine_status_label_all_failed(self, automation_handler):
        ...
        label = automation_handler._determine_status_label(all_failed)  # noqa: SLF001
        assert label == "failed"
    ...
    def test_determine_status_label_partial(
        ...
        label = automation_handler._determine_status_label(failed_task_results)  # noqa: SLF001
        assert label == "partial"

    def test_determine_status_label_empty_results(self, automation_handler):
        """Test label for empty results list."""
        label = automation_handler._determine_status_label([])  # noqa: SLF001
...
class TestShouldRunAutomation:
    ...
    def test_should_run_automation_enabled(self, automation_handler):
        ...
        assert automation_handler._should_run_automation("post_results_as_comment")  # noqa: SLF001
        assert automation_handler._should_run_automation("update_issue_status")  # noqa: SLF001
    ...
    def test_should_run_automation_unknown_feature(self, automation_handler):
        ...
        assert not automation_handler._should_run_automation("nonexistent_feature")  # noqa: SLF001
...
class TestPostResults:
    ...
    async def test_post_results_to_issue(
        ...
        await automation_handler._post_results(  # noqa: SLF001
            sample_task_results,
            context,
            summary,
        )
...
class TestUpdateLabels:
    ...
    async def test_update_labels_successful_tasks(
        ...
        await automation_handler._update_labels(  # noqa: SLF001
            sample_task_results,
            context,
            summary,
        )
...
class TestCheckMergeEligibility:
    ...
    def test_check_merge_eligibility_all_conditions_met(
        ...
        eligible, reason = automation_handler._check_merge_eligibility(  # noqa: SLF001
            mock_pr,
            sample_task_results,
        )
...
class TestAutoMergePrs:
    ...
    async def test_auto_merge_prs_successful(
        ...
        await automation_handler._auto_merge_prs(  # noqa: SLF001
            sample_task_results,
            context,
            summary,
        )
